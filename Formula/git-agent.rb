class GitAgent < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/FradSer/ga-cli/releases/download/v0.1.0/git-agent-darwin-arm64.tar.gz"
      sha256 "7057e3a096fda458c4d05eabc992b761bd367f784c3008387a5754c2518e8af6"
    else
      url "https://github.com/FradSer/ga-cli/releases/download/v0.1.0/git-agent-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/FradSer/ga-cli/releases/download/v0.1.0/git-agent-linux-arm64.tar.gz"
      sha256 "310eb07a66038684b53ced631313562f091316f0be71ef1411db5a6d1999878c"
    else
      url "https://github.com/FradSer/ga-cli/releases/download/v0.1.0/git-agent-linux-amd64.tar.gz"
